...
import MyCv from "../assets/Mark-Cv.pdf"
  ...
  return (
    <section className="about section" id="about">
      ...
      <div className="about_container container grid">
        <img
          src="https://replicate.delivery/pbxt/8J3aAVw6gb5oHhVpNSoV9k74FNY90VuYroRiP13H9oO9ISZE/out..jpg"
          alt=""
          className="about_img"
        />
        <div className="about_data">
          ...
          <p className="about_description">
            FullStack developer majoring in Frontend development. I create web
