      ...
      <div className="contact_container container grid">
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              <i className="bx bxl-discord-alt contact_card-icon"></i>

              <h3 className="contact_card-title">Discord</h3>
              <span className="contact_card-data">Username: nthei</span>

              <a
                href="https://discordapp.com/users/mark_254"
                className="contact_button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
        ...
        <div className="contact_content">
          ...
          <form className="contact_form" ref={form} onSubmit={sendEmail}>
            <div className="contact_form-div">
              <label htmlFor="client_name" className="contact_form-tag">
                Name
              </label>
              <input
                type="text"
            ...
            <div className="contact_form-div">
              <label htmlFor="client_email" className="contact_form-tag">
                Email
              </label>
              <input
                type="email"
